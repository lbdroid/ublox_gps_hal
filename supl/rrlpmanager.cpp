...
*/
/*******************************************************************************
 * $Id: rrlpmanager.cpp 64651 2013-01-10 10:06:19Z michael.ammann $
 * $HeadURL: http://svn.u-blox.ch/GPS/SOFTWARE/hmw/android/release/release_2.0/supl/rrlpmanager.cpp $
 ******************************************************************************/
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
//			pAux->assistDataReceived = true;
        ...
        LOGI("%s:%d assistDataAck prepared", __FUNCTION__, __LINE__);
    }
...
static char *buildRrlpAssistAck(int *pOutSize, int referenceNumber)
{
    ...
    LOGI("%s: reference number = %d", __FUNCTION__, referenceNumber);
